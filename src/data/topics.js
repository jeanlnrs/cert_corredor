...
export const TOPICS = [
  {
    ...
    color: '#0ea5e9',
    summary: 'Características de la economía panameña, sectores, instituciones financieras, Panamá como hub logístico e indicadores estadísticos del sistema bancario.',
    lessons: [
      {
      ...
      {
        title: 'Indicadores económicos y tasas del sistema bancario',
        general: true,
        blocks: [
          { type: 'p', text: 'El examen puede incluir cifras estadísticas concretas del sistema bancario panameño. La fuente oficial es la Superintendencia de Bancos de Panamá (SBP).' },
          { type: 'table', head: ['Indicador', 'Referencia histórica (2017-2018)', 'Nota'], rows: [
            ['Tasa promedio de depósitos a plazo fijo', '≈ 2.30%', 'Dato histórico SBP. El examen puede preguntar cifras vigentes; revisa la web de la SBP.'],
            ['Tasa promedio de préstamos personales', '≈ 7–9%', 'Varía por segmento y plazo.'],
            ['Tasa preferencial (prime rate local)', 'Ligada a la prime de EE.UU. + spread', 'Sin banco central, la prime de EE.UU. es la referencia base.'],
            ['Inflación anual', '≈ 0.5–1.5%', 'Baja y vinculada a la inflación de EE.UU. por la dolarización.'],
            ['Crecimiento del PIB real (pre-COVID)', '≈ 4–6% anual', 'Una de las economías de mayor crecimiento de la región en la última década.'],
            ['Activos del Centro Bancario Internacional', '> $130,000 millones', 'Segundo centro financiero de América Latina después de São Paulo.'],
          ] },
          { type: 'callout', tone: 'key', text: 'Tasa de depósitos a plazo fijo 2017-2018 ≈ 2.30% (Superintendencia de Bancos). Este dato específico ha aparecido en el examen.' },
          { type: 'p', text: 'Características del Centro Bancario Internacional (CBI):' },
          { type: 'list', items: [
            'Supervisado por la Superintendencia de Bancos de Panamá (SBP), creada por el Decreto Ley 9 de 1998.',
            'Licencias: General (operaciones locales e internacionales), Internacional (solo desde Panamá hacia el exterior) y de Representación.',
            'Uno de los centros bancarios offshore más importantes de América Latina.',
            'Sin banco central → los bancos gestionan su propia liquidez; la SBP exige coeficientes de liquidez.',
            'La tasa de interés local se forma por la libre oferta y demanda de fondos (sin tasa de política monetaria).',
            'El FECI (Fondo Especial de Compensación de Intereses) es una sobretasa de 1% aplicada sobre préstamos bancarios mayores de B/.5,000, que queda exenta si la emisión se coloca por bolsa.',
          ] },
          { type: 'table', head: ['Concepto', 'Descripción'], rows: [
            ['Balanza comercial', 'Diferencia entre exportaciones e importaciones de bienes. Panamá es típicamente importador neto de bienes pero exportador neto de servicios.'],
            ['Balanza de pagos', 'Registra todas las transacciones económicas de un país con el exterior (cuenta corriente + cuenta de capital + cuenta financiera).'],
            ['Inversión Extranjera Directa (IED)', 'Flujo de capital con control sobre la empresa; genera empleo y transferencia tecnológica. Distinta de la inversión de portafolio (solo compra de títulos).'],
            ['Deuda pública', 'Administrada por el MEF; los bonos soberanos de Panamá se emiten en dólares y se negocian en mercados internacionales (bonos globales).'],
            ['Calificación soberana', 'Panamá tiene grado de inversión (BBB, Baa2 aprox.); clave para el costo de endeudamiento del Estado.'],
          ] },
          { type: 'callout', tone: 'tip', text: 'Para el examen: sin banco central → sin tasa de política monetaria. Las tasas de interés panameñas las fijan los bancos según la prime de EE.UU. y la competencia. La fuente de datos es la SBP (para tasas bancarias) y el INEC/Contraloría (para PIB, inflación, empleo).' },
        ],
      },
    ],
  },
  {
    ...
    lessons: [
      ...
      {
        title: 'Flujos de capital internacional',
        general: true,
        blocks: [
          { type: 'table', head: ['Tipo de inversión', 'Características', 'Ejemplo'], rows: [
            ['Inversión Extranjera Directa (IED)', 'El inversionista adquiere control sobre la empresa (generalmente > 10% de las acciones). Genera empleo, transferencia tecnológica y compromiso a largo plazo.', 'Empresa colombiana construye una planta en Uruguay.'],
            ['Inversión de portafolio', 'Compra de acciones, bonos u otros valores SIN control sobre la empresa. Más volátil; puede salir rápidamente.', 'Inversionista colombiano compra acciones de empresa uruguaya sin control.'],
            ['Deuda soberana (bonos globales)', 'Emisión de deuda del gobierno en mercados internacionales; negociada OTC en USD u otra divisa.', 'Bonos del Tesoro de Panamá.'],
          ] },
          { type: 'callout', tone: 'key', text: 'Clave de examen: un inversionista que compra acciones sin control = inversión de PORTAFOLIO (no IED). La diferencia está en si hay o no control sobre la empresa.' },
          { type: 'list', items: [
            'Balanza de pagos = Cuenta Corriente + Cuenta de Capital + Cuenta Financiera.',
            'Cuenta corriente: bienes (balanza comercial) + servicios + rentas + transferencias (remesas).',
            'Un déficit en cuenta corriente se financia con superávit en la cuenta financiera (endeudamiento o IED).',
            'Un país con tipo de cambio flotante permite que la moneda se deprecie para corregir el déficit; con tipo fijo, el gobierno debe DEVALUAR.',
          ] },
        ],
      },
    ],
    ...
    lessons: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'callout', tone: 'key', text: 'Régimen fijo con déficit en balanza de pagos: el gobierno DEVALÚA (decisión oficial). Esto encarece las importaciones y abarata las exportaciones, mejorando el déficit. En régimen flotante la moneda se DEPRECIA sola por el mercado; NO hace falta gastar reservas.' },
          { type: 'table', head: ['Régimen cambiario', 'Quién ajusta', 'Herramienta', 'Efecto sobre déficit'], rows: [
            ['Fijo', 'Gobierno / Banco Central', 'Devaluación oficial', 'Mejora el déficit: exportaciones más baratas, importaciones más caras.'],
            ['Flotante', 'Mercado (oferta/demanda)', 'Depreciación de mercado', 'Corrección automática; no requiere uso de reservas.'],
            ['Administrado / Ajustable', 'Banco Central interviene parcialmente', 'Compra/venta de reservas', 'Estabiliza el tipo de cambio dentro de una banda.'],
          ] },
        ],
      },
      {
    ...
    lessons: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'callout', tone: 'key', text: 'La Fed Funds Rate (tasa de fondos federales) es una tasa de MUY corto plazo: afecta directamente los bonos cortos, las letras del Tesoro y la tasa de descuento, pero NO los precios de los bonos a largo plazo. Estos dependen más de las expectativas de inflación y crecimiento a largo plazo.' },
          { type: 'table', head: ['¿Qué afecta un aumento de la Fed Funds?', '¿Lo afecta?'], rows: [
            ['Precios de Letras del Tesoro (T-bills)', 'SÍ — reaccionan de inmediato.'],
            ['Precios de bonos a corto plazo', 'SÍ — correlación directa.'],
            ['Tasa de descuento del banco central', 'SÍ — se mueven en la misma dirección.'],
            ['Precios de bonos a LARGO plazo', 'NO necesariamente — dependen de expectativas de inflación y crecimiento, no de la Fed Funds.'],
          ] },
        ],
      },
    ],
    ...
    lessons: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'callout', tone: 'key', text: 'La TIR es la tasa que iguala el VAN a cero (por ensayo y error). Representa el crecimiento constante implícito esperado durante la ejecución del proyecto. Se usa para decidir entre proyectos: aceptar si TIR > costo de capital (WACC). Todo esto es simultáneamente cierto.' },
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        title: 'Instrumentos del mercado local: VCNs y otros',
        general: true,
        blocks: [
          { type: 'p', text: 'Los Valores Comerciales Negociables (VCNs) son el equivalente panameño del papel comercial internacional. Son el instrumento de corto plazo más usado en el mercado de capitales local.' },
          { type: 'table', head: ['Característica', 'Detalle'], rows: [
            ['Nombre local', 'Valores Comerciales Negociables (VCNs)'],
            ['Equivalente internacional', 'Papel comercial (commercial paper)'],
            ['Tipo', 'Deuda de corto plazo, no asegurada (sin garantía específica — quirografaria)'],
            ['Propósito', 'Mejorar el flujo de efectivo (capital de trabajo) de la empresa emisora'],
            ['Plazo', 'Corto plazo (generalmente hasta 1 año en el mercado de dinero)'],
            ['Garantía', 'Solo el crédito general del emisor (no asegurada)'],
            ['Beneficio', 'Al emitirse por bolsa, el emisor evita el FECI (1%) y los intereses quedan exentos de ISR para el inversionista'],
            ['Mercado', 'Se negocian en la Bolsa Latinoamericana de Valores (Latinex)'],
          ] },
          { type: 'callout', tone: 'key', text: 'Pregunta de examen: cuando una empresa emite instrumentos de deuda NO asegurados y de corto plazo para mejorar su flujo de efectivo, se llaman VCNs (en Panamá) o papel comercial (internacionalmente). No confundir con aceptaciones bancarias (garantizadas por un banco) ni con repos.' },
          { type: 'table', head: ['Instrumento del mercado de dinero', 'Descripción'], rows: [
            ['VCN / Papel comercial', 'Deuda corporativa de CP, sin garantía, emitida para capital de trabajo.'],
            ['Aceptación bancaria', 'Letra de cambio garantizada por un banco; usada en comercio exterior.'],
            ['Certificado de Depósito (CD) negociable', 'Depósito a plazo fijo del banco que puede venderse en el mercado secundario.'],
            ['Repo (acuerdo de recompra)', 'Venta de valores con compromiso de recompra; préstamo colateralizado.'],
            ['Letras del Tesoro (T-bills)', 'Deuda del gobierno a ≤ 1 año; referencia libre de riesgo a corto plazo.'],
          ] },
        ],
      },
    ],
    ...
    lessons: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'callout', tone: 'key', text: 'SPREAD = Ask (offer) − Bid. El ask es el precio más bajo al que un vendedor está dispuesto a vender; el bid es el precio más alto que un comprador ofrece. Las órdenes a mercado se ejecutan al ask (si compras) o al bid (si vendes). Las órdenes límite colocadas por DEBAJO del offer (bid) quedan en el libro y AGREGAN liquidez al mercado; las órdenes a mercado y las que cruzan el spread CONSUMEN liquidez.' },
        ],
      },
    ],
  },
    ...
    lessons: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'callout', tone: 'key', text: 'Correlación −1.0 (perfectamente negativa): los activos X e Y tienen movimientos INVERSAMENTE PROPORCIONALES — cuando uno sube el otro baja en la misma magnitud. Esto proporciona la máxima diversificación posible. No confundir con beta (que mide el riesgo respecto al mercado); la correlación mide la relación entre dos activos específicos.' },
          { type: 'table', head: ['Grado de eficiencia del mercado', 'Qué información refleja el precio', 'Quién puede ganar'], rows: [
            ['Débil', 'Solo precios históricos y datos pasados de negociación.', 'No funciona el análisis técnico. Sí puede funcionar el análisis fundamental.'],
            ['Semifuerte (medio)', 'Toda la información PÚBLICA disponible (precios, estados financieros, noticias, etc.).', 'Ningún análisis de información pública genera rendimientos extra de forma consistente.'],
            ['Fuerte', 'Toda la información, incluida la información PRIVADA (privilegiada).', 'Nadie puede ganar de forma consistente, ni con información interna.'],
          ] },
          { type: 'callout', tone: 'tip', text: 'Para el examen: "el precio ya refleja toda la información pública" = grado SEMIFUERTE (medio). El grado débil solo incluye precios históricos. El grado fuerte incluye hasta información privilegiada.' },
        ],
      },
    ],
  },
    ...
    lessons: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'table', head: ['Instrumento estructurado', 'Garantía / activo subyacente', 'Tasas'], rows: [
            ['MBS / MDO (Mortgage Debt Obligations)', 'Exclusivamente un grupo de hipotecas residenciales o comerciales.', 'Puede ser fija o variable.'],
            ['ABS (Asset Backed Securities)', 'Otros activos financieros: tarjetas de crédito, préstamos de autos, préstamos estudiantiles, etc. NO hipotecas.', 'Puede ser fija o variable.'],
            ['CDO (Collateralized Debt Obligation)', 'Mezcla de deuda (bonos, préstamos, MBS); dividida en tranches por riesgo.', 'Varía por tranche.'],
          ] },
          { type: 'callout', tone: 'key', text: 'MDO/MBS = garantizados SOLO por hipotecas. ABS = garantizados por OTROS activos (no hipotecas). Esta distinción aparece directamente en el examen.' },
          { type: 'p', text: 'Cálculo de retorno en combinaciones acciones + opciones:' },
          { type: 'list', items: [
            'Si tienes acciones Y opciones call en la misma posición, calcula el retorno de cada componente por separado.',
            'Acciones: retorno = (precio final − precio compra) / precio compra.',
            'Call comprado: valor final = máx(spot − strike, 0). Si valor final = prima pagada, el retorno de la opción es 0 (punto de equilibrio).',
            'Ej. (EF83): 100 acciones a $9.00 + call strike $9.50 con prima $1.25. Spot final $10.75. Acciones: (10.75 − 9.00)/9.00 = 19.4%. Call: valor = 10.75 − 9.50 = $1.25 = prima pagada → retorno 0. El retorno total de la posición combinada = 19.4% (el call no añade ni resta en este caso).',
          ] },
        ],
      },
    ],
    ...
    lessons: [
      {
        ...
        blocks: [
          ...
          { type: 'callout', tone: 'key', text: 'FLUJO DE CAJA NETO = Flujo de Operación + Flujo de Inversión + Flujo de Financiamiento. Es el efectivo sobrante luego de contabilizar TODAS las actividades. No confundir con el flujo operativo (solo operaciones) ni con el EBIT.' },
          { type: 'table', head: ['Concepto', 'Qué mide', 'Fórmula'], rows: [
            ['Flujo de caja operativo', 'Efectivo generado solo por las operaciones del negocio.', 'Separado en el EFE.'],
            ['Flujo de caja de inversión', 'Compra/venta de activos fijos, inversiones.', 'Separado en el EFE.'],
            ['Flujo de caja de financiamiento', 'Préstamos, emisión de acciones/bonos, dividendos pagados.', 'Separado en el EFE.'],
            ['Flujo de caja NETO', 'Suma de los tres flujos anteriores. Efectivo neto del período.', 'Operación + Inversión + Financiamiento.'],
          ] },
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: 'callout', tone: 'tip', text: 'SOLVENCIA: la razón Activos de Largo Plazo / Pasivos de Largo Plazo mide la capacidad de la empresa de cubrir sus obligaciones de largo plazo con sus activos de largo plazo. No confundir con liquidez (que usa activos y pasivos circulantes). La eficiencia operativa (EBIT / ventas o similar) refleja el resultado después de todos los gastos excluyendo intereses e impuestos — es el indicador que "excluye impuestos e intereses" que pregunta el examen.' },
        ],
      },
      {
